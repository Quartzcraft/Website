...
require_once('libs/QuartzCore.php');
define('WEB_UI_VERSION', 'v2.0-6-gef42dcf');
...
define("MYSQL_PASSWORD", "database1");
define("MYSQL_DATABASE", "prism");
...
define("QC_DATABASE", "QuartzCore");
define("QC_PORT", 3306);

//The url location of the XenAPI instance.
